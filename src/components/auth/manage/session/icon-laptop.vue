<template>
  <svg
    ...
    viewBox="569.4 86.3 83.6 48.2" class="cl-activeDeviceIcon cl-activeDeviceIcon__desktop 🔒️ cl-internal-1xb7lqw"
  >
    <path
    ...
    <path
      ...
      stroke-width="0.3" d="M611.2 88.5a.3.3 0 1 0 0-.5.3.3 0 1 0 0 .5Z"
      clip-rule="evenodd"
    />
    <path
      fill="var(--cl-chassis-bottom, #191919)"
      fill-rule="evenodd"
      d="M569.4 133.3v-.5H653v.5s-1.9.6-4 .8c-1.4.1-3.7.4-8.9.4h-57.4c-4.5 0-8.3-.3-10-.5-1.7-.2-3.3-.7-3.3-.7Z" clip-rule="evenodd"
    />
    <path
