...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AuthManageAddPasskey: typeof import('./components/auth/manage/add-passkey.vue')['default']
    AuthManageEmailInfo: typeof import('./components/auth/manage/email/info.vue')['default']
    AuthManageInfo: typeof import('./components/auth/manage/info.vue')['default']
...
declare global {
  ...
  const AuthManageAddPasskey: typeof import('./components/auth/manage/add-passkey.vue')['default']
  const AuthManageEmailInfo: typeof import('./components/auth/manage/email/info.vue')['default']
  const AuthManageInfo: typeof import('./components/auth/manage/info.vue')['default']
