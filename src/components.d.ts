...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AuthManagePasskeyIcon: typeof import('./components/auth/manage/passkey-icon.vue')['default']
...
declare global {
  ...
  const AuthManagePasskeyIcon: typeof import('./components/auth/manage/passkey-icon.vue')['default']
