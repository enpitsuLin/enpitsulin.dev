...
slug: todo-mvc-app-with-tauri-1
description: rust太难学了？学习了rust不会实践？简单使用 Tauri 搭建经典实战项目TodoMVC
  来做实践吧。你会发现rust真的很好玩，tauri也是非常的快，转变思维使用rust来写代码真的很爽。
tags:
  - Tauri
  - Rust
publishedAt: 2022-05-02T17:29:00.000Z
---
...
既然已经能够构造类了，那么我们希望能对 sqlite 进行 CURD 等操作，当然需要相应的方法，如 `get_todos`、`get_todo(id)`、`new_todo(todo)`、`update_todo(todo)`，没有删除的方法因为设计表就已经设计了 is\_delete 字段，决定我们的删除还是软删除，硬删除暂时不(lān de)实现
...
![get\_todos|789x797](https://images-enpitsulin.oss-cn-beijing.aliyuncs.com/images/20220502222623.png)
